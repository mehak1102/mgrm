  ...
  return (
    <section className="rounded-2xl border border-edge bg-card p-5 md:p-6">
      <div className="flex items-center gap-2 mb-1">
        ...
        <p className="text-xs font-black uppercase tracking-widest text-brand">Recovery Stories</p>
      </div>
      <h2 className="text-xl md:text-2xl font-black text-fg">Before & After</h2>
      <p className="text-sm text-fg-muted mt-1 mb-5">
        Real journeys from customers — drag to compare.
      </p>
