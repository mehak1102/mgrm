...
export default function Navbar() {
  ...
  return (
    ...
    <header className="site-navbar sticky top-0 z-50 relative bg-app/90 dark:bg-slate-950/90 backdrop-blur-xl border-b border-slate-100 dark:border-white/10 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-2.5 sm:px-4 py-2.5 sm:py-3.5 flex items-center gap-1.5 sm:gap-2 lg:gap-2.5 xl:gap-3 min-w-0">
        {/* <Logo3D /> */}
...
<Link to="/" className="navbar-logo-link flex items-center shrink-0">
  ...
  />
        ...
        <div className="flex gap-1 sm:gap-1.5 items-center shrink-0 ml-auto lg:ml-0">
          <ThemeSelector />
          <button
            type="button"
            onClick={() => navigate("/wishlist")}
            className="site-navbar-icon-btn p-1.5 sm:p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800 relative"
            aria-label={t("nav.wishlist")}
          >
            <HeartPulse className="w-[18px] h-[18px] sm:w-5 sm:h-5" />
            {wishlist.length > 0 && (
              <span className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 text-[10px] sm:text-xs bg-pink-500 text-white rounded-full w-4 h-4 sm:w-5 sm:h-5 grid place-items-center">
                {wishlist.length}
              </span>
            )}
          </button>
          ...
          {!authReady ? null : user ? (
            <button
              ...
              className="site-navbar-icon-btn p-1.5 sm:p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800"
          ...
          >
            ...
            <span className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 text-[10px] sm:text-xs bg-red-500 text-white rounded-full w-4 h-4 sm:w-5 sm:h-5 grid place-items-center">
              {cartCount}
            </span>
          </button>
          ...
          <button
            ...
            className="site-navbar-icon-btn lg:hidden p-1.5 sm:p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800"
