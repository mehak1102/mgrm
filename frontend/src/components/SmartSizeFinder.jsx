...
//             <div>
//               <h3 className="text-2xl font-black text-fg">Enter measurement</h3>
...
// //         <button
// //           onClick={onClose}
// //           className="absolute top-5 right-5 z-20 w-10 h-10 rounded-full bg-card shadow-lg flex items-center justify-center"
// //         >
// //           <X size={18} />
// //         </button>
...
// //           <div className="mt-6 relative h-[420px] rounded-[28px] bg-card border overflow-hidden">
...
// //                 <p className="mt-5 font-black text-fg">
// //                   Upload Image
// //                 </p>
