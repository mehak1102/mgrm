  ...
  return (
    <div ref={rootRef} className={`theme-selector relative ${className}`}>
      <button
        ...
        className="flex items-center gap-1.5 sm:gap-2 h-9 sm:h-11 px-2 sm:px-3 rounded-full border border-edge dark:border-white/10 bg-card dark:bg-zinc-800 hover:bg-surface-hover dark:hover:bg-zinc-700 text-fg dark:text-zinc-100 transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-primary)]"
      >
