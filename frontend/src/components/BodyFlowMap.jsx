...
//             className="absolute z-20 w-16 h-16 bg-card overflow-hidden shadow-md hover:scale-110 transition"
...
//                 className="absolute z-30 w-24 rounded-xl overflow-hidden shadow-xl hover:scale-110 transition bg-card"
...
//       onClick={() => go(item.query)}
//       className="absolute z-40 w-44 rounded-2xl overflow-hidden bg-card shadow-[0_16px_40px_rgba(15,23,42,0.12)] hover:scale-105 transition"
//       style={{
//         left: `${item.card.x}%`,
//         top: `${item.card.y}%`,
