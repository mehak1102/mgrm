...
export default function Login() {
  ...
  return (
    <main className="relative min-h-screen bg-app-gradient p-5 grid place-items-center transition-colors duration-300">
      ...
      <section className="w-full max-w-6xl min-h-[720px] bg-card/95 backdrop-blur-xl rounded-[46px] shadow-theme-lg overflow-hidden grid lg:grid-cols-[0.9fr_1.1fr] border border-edge transition-colors duration-300">
        <div className="p-8 md:p-14 flex flex-col justify-center bg-surface-elevated/80 border-r border-edge transition-colors duration-300">
          <Link to="/" className="mb-10 inline-flex">
            <img src="/logo.png" alt="MGRM Medicare" className="h-14 object-contain" />
          </Link>

          <p className="text-purple-700 text-brand font-black tracking-widest text-sm transition-colors duration-300">WELCOME BACK</p>
          <h1 className="text-5xl font-black mt-3 text-fg">Hello Again!</h1>
          <p className="text-gray-500 text-fg-muted mt-3 transition-colors duration-300">Sign in to continue shopping and track your orders.</p>
          ...
          <div className="mt-7 flex items-center gap-4">
            ...
            <span className="text-fg-muted text-sm transition-colors duration-300">or</span>
            <div className="h-px flex-1 bg-[var(--border-color)]" />
          </div>

          <p className="mt-6 text-center text-gray-500 text-fg-muted transition-colors duration-300">
            No account?{" "}
            <Link to="/register" className="font-black text-purple-700 text-brand transition-colors duration-300">
              Register
            </Link>
          </p>
        </div>
