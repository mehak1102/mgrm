...
export default function Wishlist() {
  ...
  return (
    <main className="relative bg-[#f6f7fb] bg-app min-h-screen overflow-hidden">
      <FloatingMedicalBg />
  ...
  Wishlist ({validWishlist.length})
          ...
          <div className="bg-card rounded-2xl px-5 py-3 shadow font-bold text-fg-muted">
        ...
        {/* EMPTY STATE */}
        {wishlist.length === 0 && (
          <div className="bg-card rounded-[30px] p-12 text-center shadow">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          ...
          {/* {wishlist.map((p) => (
            ...
            <div
              key={p._id}
              className="group bg-card rounded-[26px] overflow-hidden shadow-[0_20px_60px_rgba(15,23,42,0.08)] hover:-translate-y-2 hover:shadow-[0_30px_80px_rgba(15,23,42,0.12)] transition duration-500"
            >
              {/* IMAGE */}
              ...
              <div className="p-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  {p.discountPrice && (
                    <span className="text-fg-muted/80 line-through text-sm">
                      ₹{p.price}
                    </span>
                  )}
                </div>
