        ...
        <section className="relative py-20">
          <div className="max-w-7xl mx-auto px-5 grid lg:grid-cols-[0.95fr_1.05fr] gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-fg-muted text-lg mt-6 max-w-2xl">
              ...
              <div className="grid sm:grid-cols-3 gap-4 mt-8">
                {[
                  ...
                  <div key={title} className="bg-card rounded-3xl p-5 shadow">
            ...
            <form
              ...
              className="bg-card rounded-[38px] p-8 shadow-xl"
            >
        ...
        <section className="max-w-7xl mx-auto px-5 pb-20">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {[
              ...
              <div key={item.title} className="bg-card rounded-3xl p-6 shadow">
                <item.icon className="text-purple-700" />
                <h3 className="font-black mt-4">{item.title}</h3>
                <p className="text-fg-muted mt-2">{item.text}</p>
