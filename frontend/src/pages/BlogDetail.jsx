            ...
            <div className="grid gap-10">
              {content.map((block) => (
                <section key={block.heading}>
                  ...
                  <p className="text-gray-500 dark:text-zinc-400 leading-8 mt-3">{block.text}</p>
                </section>
              ))}
            </div>

            <div className="mt-12 rounded-[28px] bg-purple-50 dark:bg-zinc-900 border border-purple-100 dark:border-white/10 p-8 transition-colors duration-300">
              <h3 className="text-3xl font-black text-slate-900 dark:text-zinc-100">Quick tip</h3>
              <p className="text-gray-600 dark:text-zinc-400 leading-8 mt-3">
