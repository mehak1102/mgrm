          ...
          <section className="bg-card dark:bg-zinc-900 rounded-[34px] p-7 shadow-[0_25px_80px_rgba(15,23,42,0.09)] transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {/* <input
                ...
                className="bg-slate-50 bg-card rounded-2xl px-4 py-4 outline-none focus:ring-2 focus:ring-purple-500"
              /> */}
              <input
  required
  type="text"
...
/>
              ...
              <textarea
                ...
                className="md:col-span-2 bg-slate-50 bg-card rounded-2xl px-4 py-4 outline-none focus:ring-2 focus:ring-purple-500 min-h-32"
              />
            </div>
          </section>

          <aside className="bg-card rounded-[34px] p-7 shadow-[0_25px_80px_rgba(15,23,42,0.09)] h-fit sticky top-24">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-purple-50 text-purple-700 rounded-2xl grid place-items-center">
                <CreditCard />
              </div>
            ...
            <div className="grid gap-4 max-h-[320px] overflow-auto pr-1">
              {cart.map((item) => (
                <div
                  ...
                  className="flex items-center gap-3 bg-slate-50 bg-card rounded-2xl p-3"
                >
                  <img
                    src={item.image || "/products/knee.png"}
                    onError={(e) => (e.currentTarget.src = "/products/knee.png")}
                    className="w-16 h-16 rounded-xl object-cover bg-card"
                    alt={item.name}
                  />
