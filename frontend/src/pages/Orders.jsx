                  ...
                  <div className="grid gap-4 mt-5">
                    {order.items?.map((item, index) => (
                      <div
                        ...
                        className="flex items-center gap-4 bg-slate-50 bg-surface-hover/80 rounded-3xl p-4 border border-transparent dark:border-white/5"
                      >
                        <img
                          ...
                          className="w-20 h-20 rounded-2xl object-cover bg-card"
                          alt={item.name}
                        />
