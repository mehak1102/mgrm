  ...
  return (
    <main className="bg-[#f7f7f7] min-h-screen">
      <div className="max-w-[1400px] mx-auto px-6 py-10 grid lg:grid-cols-2 gap-14">
       ...
       <div className="flex-1 bg-white rounded-3xl p-6 shadow-sm min-h-[620px] flex items-center justify-center overflow-hidden">
  <img
    src={activeImg}
  ...
  />
        ...
        <section>
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-6 bg-gray-100 px-4 py-2 rounded-lg w-fit">
